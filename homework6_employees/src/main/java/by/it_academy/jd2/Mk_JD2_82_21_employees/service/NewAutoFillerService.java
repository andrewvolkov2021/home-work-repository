...
public class NewAutoFillerService implements IAutoFillerService {
    ...
    private static final NewAutoFillerService instance = new NewAutoFillerService();

    private static final int MAX_VALUE_OF_SALARY_PARAM_NAME = 100_000_000;

    private NewAutoFillerService() {
    }
    ...
    public void fillDateBase(int countEmployee) {
        ...
        NewPositionService.getInstance().autoAddingPositions(listOfPositions);
        ...
        NewDepartmentService.getInstance().autoAddingDepartment(listOfDepartments);
        ...
        NewDepartmentService.getInstance().autoAddingParentalDepartment(id, arrayIndexParentalDepartmentId);
        ...
        NewEmployeeService.getInstance().autoAddingOfEmployees(listOfEmployee);
    }
    ...
    private Long[] getArrayOfNewDepartmentId(int count) {
        List<Long> listId = NewDepartmentService.getInstance().getListOfDepartmentId();
    ...
    private List<Employee> getListOfEmployee(int countEmployee, String[] arrayOfEmployeeName,
        ...
        for (int i = 0; i < countEmployee; i++) {
            ...
            Department department = NewDepartmentService.getInstance().
                    getDepartment(autoGenerateDepartment(arrayOfDepartmentId));
            employee.setDepartment(department);

            Position position = NewPositionService.getInstance().getPosition(autoGeneratePosition(arrayOfPositionId));
    ...
    public static NewAutoFillerService getInstance(){
        return instance;
    }
}
