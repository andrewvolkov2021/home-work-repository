...
<html>
    ...
    <body>
        <form action="/Mk-JD2-82-21-chat-0.0.0-SNAPSHOT/messageCheck" method="POST">
            ...
            <input type="submit" onclick='location.href="http://localhost:8080/Mk-JD2-82-21-chat-0.0.0-SNAPSHOT/views/message.jsp"' value="Отправить сообщение" /><br><br>
            <input type="button" onclick='location.href="http://localhost:8080/Mk-JD2-82-21-chat-0.0.0-SNAPSHOT/chat"' value="Получить сообщения">
